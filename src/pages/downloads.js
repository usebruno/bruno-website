    ...
    >
      ...
      <main className="flex flex-grow flex-col px-4">
        ...
        <div className="mt-4 py-2 px-3 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 max-w-[600px] text-sm">
          <p>
            <strong>Note:</strong> With the release of v1.28.0, we've shifted to
            treating all Request Variables as strings instead of inferring the
            data type from the value. See{' '}
            <a
        ...
        >
          ...
          <div className="ml-3 flex flex-col">
            <p>
              Golden Edition now available at{' '}
              <span className="text-yellow-600 text-lg ">$19</span> !
            </p>
            <p>
              <a
                href="https://www.youtube.com/watch?v=R3F6Gu7tG8M"
                target="_blank"
                rel="noreferrer"
                className="link"
              >
                ...
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_x64_mac.dmg`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_x64_mac.zip`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_arm64_mac.dmg`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_arm64_mac.zip`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
              ...
              <table className="text-left text-gray-500 mt-6">
                ...
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_amd64_linux.deb`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_x86_64_linux.AppImage`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
              ...
              <table className="text-left text-gray-500 mt-6">
                ...
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_x64_win.exe`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="py-3 pl-6 pr-10">
                      <a
                        href={`https://github.com/usebruno/bruno/releases/download/v${selectedVersion}/bruno_${selectedVersion}_x64_win.zip`}
                        target="_blank"
                        rel="noreferrer"
                        className="link"
                      >

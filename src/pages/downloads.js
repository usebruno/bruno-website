          ...
          <table className="text-left text-gray-500">
            ...
            <tbody>
              <tr className="bg-white border-b">
                ...
                <a href="https://github.com/usebruno/bruno/releases/download/v0.10.2/bruno_0.10.2_x64_mac.dmg" target="_blank" rel="noreferrer" className='link'>
                  Download
                </a>
                </td>
              </tr>
              ...
              <tr className="bg-white border-b">
                ...
                <td className="py-3 pl-6 pr-10">
                <a href="https://github.com/usebruno/bruno/releases/download/v0.10.2/bruno_0.10.2_amd64_linux.deb" target="_blank" rel="noreferrer" className='link'>
                  Download
                </a>
                </td>
              </tr>
              ...
              <tr className="bg-white border-b">
                ...
                <td className="py-3 pl-6 pr-10">
                <a href="https://github.com/usebruno/bruno/releases/download/v0.10.2/bruno_0.10.2_x86_64_linux.AppImage" target="_blank" rel="noreferrer" className='link'>
                  Download
                </a>
                </td>
              </tr>
              ...
              <tr className="bg-white border-b">
                ...
                <td className="py-3 pl-6 pr-10">
                <a href="https://github.com/usebruno/bruno/releases/download/v0.10.2/bruno_0.10.2_x64_win.exe" target="_blank" rel="noreferrer" className='link'>
                  Download
                </a>
                </td>
              </tr>
              ...
              <tr className="bg-white border-b">
                ...
                <td className="py-3 pl-6 pr-10">
                <a href="https://github.com/usebruno/bruno/releases/download/v0.10.2/bruno_0.10.2_x64_win.zip" target="_blank" rel="noreferrer" className='link'>
                  Download
                </a>
                </td>
              </tr>*/}

        ...
        <section className="bg-white">
          ...
          <div className="flex flex-col mt-10">
            <div>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Notebase Technologies LLP, #47 SNIJA NIVAS, Anepalya, Adugodi, Bangalore 560030.</li>
              <li><strong>Authorized Users</strong> means any Customer employee, contractor or agent, or any other person authorized by Customer to access and use the Service through Customer's account under this Agreement..</li>
              <li><strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.</li> <li><strong>Country</strong> refers to: Karnataka, India</li>
              ...
              <p>Individuals authorized by Customer to access the Services (an “Authorized User”) may submit content or information to the Services, such as messages or files (“Customer Data”), and Customer may exclusively provide us with instructions on what to do with it. For example, Customer may provision or deprovision access to the Services, enable or disable third party integrations, manage permissions, retention and export settings, transfer or assign account access permissions, share conversation data with certain authorized users using privacy set</p>
              <p>You represent and warrant that: (i) the Content is Yours (You own it) or You have the right to use it and grant Us the rights and license as provided in these Terms, and (ii) the posting of Your Content on or through the Service does not violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of any person.</p>
              <p>Customer will (a) inform Authorized Users of all Customer policies and practices that are relevant to their use of the Services and of any settings that may impact the processing of Customer Data; and (b) ensure the transfer and processing of Customer Data under the Contract is law</p>

...
const jsonLd = {
  ...
  description:
    "Bruno is a Git-friendly, open-source API client for developers, offering offline functionality and seamless collaboration through version control systems like Git.",
  ...
  creator: {
    "@type": "Organization",
    name: "Bruno Team",
    url: "https://www.usebruno.com/about",
  },
};
          ...
          <div className="max-w-screen-xl pt-8 pb-8 mx-auto lg:pt-14">
            <div className="mr-auto place-self-center">
              ...
              >
                ...
                revolutionizing the status quo represented by Postman, Insomnia
                and similar tools out there. <br />
                <br />
                Bruno stores your collections directly in a folder on your
                filesystem. We use a plain text markup language, Bru, to save
                information about API requests. <br />
                <br />
                You can use git or any version control of your choice to
                collaborate over your API collections. <br />
                <br />
              ...
              <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a
                  ...
                  className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 transition"
                >
                  <svg
                ...
                <a
                  href="https://www.youtube.com/watch?v=b_ctmKlEOXg"
                  className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://www.youtube.com/watch?v=7bSMFpbcPiY"
                  className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"

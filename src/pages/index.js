    ...
    <div className="container flex flex-col root home-page" style={{fontFamily: 'Inter', maxWidth: '1024px'}}>
      ...
      <main className="flex flex-grow flex-col notebase-app px-4">
        ...
        <section class="bg-white dark:bg-gray-900">
          <div class="max-w-screen-xl pt-8 pb-8 mx-auto lg:py-12 lg:pt-20">
            <div class="mr-auto place-self-center">
              <h1 class="max-w-3xl mb-4 text-4xl font-bold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">Stop searching for lost api collections.</h1>
              ...
              <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="https://github.com/usebruno/bruno" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
        ...
        <section class="bg-white dark:bg-gray-900">
          <div class="max-w-screen-xl pt-10 pb-8 mx-auto lg:py-16 lg:pt-10">
            <div class="mr-auto place-self-center">
              <h1 class="max-w-3xl mb-4 text-4xl font-bold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                Introducing Bruno
              </h1>
              <p class="max-w-3xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">

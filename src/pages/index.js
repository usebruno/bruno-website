          ...
          <div className="max-w-screen-xl pt-8 pb-8 mx-auto lg:pt-14">
            <div className="mr-auto place-self-center">
              ...
              <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                ...
                <a href="https://www.youtube.com/watch?v=b_ctmKlEOXg" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 transition" >

...
export default function About() {
  return (
    ...
    >
      ...
      <main className="flex flex-grow flex-col px-4 privacy-page">
        <Navbar />
          ...
          <div className="py-8 max-w-screen-xl lg:pb-16">
            <div className="flex flex-col mt-10">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Notebase
                    Technologies LLP, 47, SNIJA NIVAS, Anepalya, Adugodi,
                    Bangalore 560030.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Bruno, accessible from{' '}
                    <a
              ...
              <p>
                ...
                reach out to us at - support@usebruno.com
              </p>
            </div>
          </div>
        </section>

      ...
      <div>
        <header className="flex items-center justify-between py-4">
          ...
          <nav className={`${menuOpen ? 'flex' : 'hidden'}`}>
            <ActiveLink href="/manifesto" label="Manifesto" />
            <ActiveLink href="/bru" label="Bru" />
            <ActiveLink href="/sponsors" label="Sponsors" />
            <ActiveLink href="/blog" label="Blog" />
            <ActiveLink href="/about" label="About" />
            <ActiveLink href="/pricing" label="Pricing" />

            <Link href="" passHref className="sm:inline-block">
            ...
            <Link href="/downloads" className="text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:ring-yellow-200 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none transition">
              Download
            </Link>
          </nav>

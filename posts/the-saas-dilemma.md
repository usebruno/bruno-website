...
* **Git**: All the alternatives out there (postman/insomnia/paw/hoppscotch etc) shoehorn users to use a custom centralized proprietary version control for collaboration. On the other hand, File based api collections allow you to chose git for collaboration which allows us to maintain our api collections in the source code repo itself.
